...
export async function userLoginUsingWeChat(
  options?: {},
) {
  return request<API.BaseResponseUrl>("http://localhost:8200/wx/wxLogin", {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function userRegisterUsingPOST(
  ...
  return request<API.BaseResponseUserVO>('/api/user/register', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
